import { reactive, hasInjectionContext, getCurrentInstance, version, unref, inject, toRef, ref, onServerPrefetch, computed, nextTick, shallowRef, shallowReactive, isReadonly, effectScope, markRaw, toRaw, watch, isRef, isShallow, isReactive, h, defineComponent, Suspense, mergeProps, Transition, provide, withAsyncContext, withCtx, createVNode, useSSRContext, defineAsyncComponent, onErrorCaptured, resolveDynamicComponent, createApp } from "vue";
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/_page_-84ac8d95.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-6f0df646.js").then(function(n) {
      return n.i;
    }).then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import("./_nuxt/default-96c412eb.js").then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-404-82efafb1.js").then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-500-0558482b.js").then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/island-renderer-a65c13ff.js").then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
