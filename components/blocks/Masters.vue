      ...
      >
        ...
        <div class="flex flex-col items-center text-white">
          <span class="text-[26px] font-[700] leading-[32px]">
            {{ master.masters_id.first_name }} {{ master.masters_id.last_name }}
          </span>
...
const { data: data }: any = useFetch(
  `${api}items/${props.block.collection}/${props.block.item}?fields=*,masters.id,masters.masters_id.first_name,masters.masters_id.last_name,masters.masters_id.skill,masters.masters_id.img`
);
</script>
